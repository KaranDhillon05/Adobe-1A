# Fix the regex issues in the PDF processor and create utility files

# Fix PDF processor regex patterns
pdf_processor_fixed = '''"""
Adobe Hackathon 2025 - Core PDF Processing Engine (Fixed Regex)
...
class PDFProcessor:
    ...
    def score_heading_candidate(self, span: TextSpan, font_stats: Dict[str, Any], 
        ...
        # Numbered sections (1.1, Chapter 1, etc.) - FIXED REGEX
...
with open("adobe_pdf_processor/core/pdf_processor.py", "w") as f:
    f.write(pdf_processor_fixed)

print("✅ Fixed regex issues in PDF processor")