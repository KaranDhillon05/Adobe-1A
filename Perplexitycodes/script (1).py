# Create the core PDF processing engine with advanced heading detection
...
# Write the core PDF processor
with open("adobe_pdf_processor/core/pdf_processor.py", "w") as f:
    f.write(core_pdf_processor)

print("✅ Created core PDF processor with advanced heading detection algorithm")