# Create Challenge 1b processor

challenge_1b_processor = '''"""
...
# Write Challenge 1b processor
with open("adobe_pdf_processor/challenge1b/processor.py", "w") as f:
    f.write(challenge_1b_processor)

print("✅ Created Challenge 1b processor")