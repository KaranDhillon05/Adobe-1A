# Create the semantic analysis engine for Challenge 1b
...
# Write the semantic analyzer
with open("adobe_pdf_processor/core/semantic_analyzer.py", "w") as f:
    f.write(semantic_analyzer)

print("✅ Created semantic analysis engine for Challenge 1b")